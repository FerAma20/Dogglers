...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val textViewHobbie: TextView = view!!.findViewById(R.id.item_hobbies)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.textViewTitle.text= dog.name
        ...
        holder.textViewHobbie.text =resources!!.getString(R.string.dog_hobbies, dog.hobbies)
    }
}
